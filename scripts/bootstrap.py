...
def package_scripts_text(repo_scan: dict[str, Any]) -> list[str]:
    if repo_scan.get("project_type") == "codex-plugin":
        return [
            "- Focused Python script check: `python -m py_compile scripts\\console.py scripts\\factory.py scripts\\diagnose.py scripts\\loop.py scripts\\skill_recommender.py`.",
