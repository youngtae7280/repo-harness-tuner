...
Thanks for improving Repo Harness Tuner. This plugin is intentionally small and repo-local: prefer focused changes that make Codex harnesses easier to design, evaluate, and maintain.
...
python -m py_compile scripts\console.py scripts\diagnose.py scripts\evaluate.py scripts\bootstrap.py scripts\history.py scripts\generate_prompt.py scripts\scan_plugins.py scripts\scan_repo_harness.py scripts\scan_skills.py scripts\worker_patterns.py
