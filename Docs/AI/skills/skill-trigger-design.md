...
## Purpose
Design valid SKILL.md frontmatter, trigger wording, and bounded workflows.

## Trigger
Use when work needs design valid SKILL.md frontmatter, trigger wording, and bounded workflows with repo evidence such as .codex-plugin/plugin.json, skills/, python-scripts, AGENTS.md.
