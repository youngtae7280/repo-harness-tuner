...
## Purpose
Review plugin.json, marketplace expectations, and cachebuster requirements.

## Trigger
Use when work needs review plugin.json, marketplace expectations, and cachebuster requirements with repo evidence such as .codex-plugin/plugin.json, skills/, python-scripts, AGENTS.md.
