...
Harness readiness: 90/100
Human involvement: 3/5

## Team Goal
Generate project-specific Codex worker teams and skill plans while the harness engine keeps them right-sized over time.
...
## Repo Evidence
- Summary: codex-plugin evidence: .codex-plugin/plugin.json, skills/, python-scripts, AGENTS.md, .codex-plugin\plugin.json. Validation hints: python scripts/console.py release-check, python scripts/console.py fixture-test, python <plugin-creator>/scripts/validate_plugin.py .
...
- `skills`
- `scripts`
- `skills/codex-harness-setup/SKILL.md`
- `skills/repo-harness-tuner/SKILL.md`
...
- Conflicts: 4
- Stale or unmanaged artifacts: 0

## Closed-Loop Feedback
- Review pressure: normal
- Eval score records: 0
- Signals: 0
...
## Roles
### harness-designer
- Purpose: Map project-specific agent behavior, human involvement, and worker policy. Ground decisions in .codex-plugin/plugin.json, skills/, python-scripts.
...
### plugin-builder
- Purpose: Update plugin manifests, CLI scripts, skills, and generated artifacts. Ground decisions in .codex-plugin/plugin.json, skills/, python-scripts.
- Visibility: background/read-only by default
- Outputs:
  - concise findings
  - repo evidence references when relevant
...
### validation-reviewer
- Purpose: Check plugin validation, skill validation, cachebuster, and smoke evidence. Ground decisions in .codex-plugin/plugin.json, skills/, python-scripts.
- Visibility: background/read-only by default
- Outputs:
  - concise findings
  - repo evidence references when relevant
